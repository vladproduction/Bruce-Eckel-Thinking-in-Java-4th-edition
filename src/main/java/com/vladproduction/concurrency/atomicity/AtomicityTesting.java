 ...
 * This means that if i is being incremented and the main thread simultaneously calls getValue(),
 ...
 * including just after i has been incremented to an odd value but before it has been incremented again in evenIncrement().
 *
